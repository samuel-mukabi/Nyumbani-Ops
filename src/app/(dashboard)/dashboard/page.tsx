    ...
    <div className="space-y-24 animate-in fade-in duration-1000">
      ...
      <section className="space-y-12">
        <div className="flex items-end justify-between pb-4 border-b border-outline-variant/10">
           ...
           <span className="text-[10px] font-bold tracking-widest text-on-surface-variant/40 uppercase">{properties.length} Total Units</span>
        </div>
              ...
              >
                 <div className="flex items-center gap-8 md:gap-12">
                    <div className="flex flex-col">
                       <span className="text-[10px] font-bold tracking-[0.2em] text-primary/40 uppercase mb-1">Property Name</span>
                    ...
                    <div className="hidden lg:flex flex-col">
                       <span className="text-[10px] font-bold tracking-[0.2em] text-on-surface-variant/30 uppercase mb-1">Location</span>
                       <p className="text-sm font-medium text-on-surface-variant/60">{property.address || "Nairobi Base"}</p>
                    </div>
                 </div>

                 <div className="flex items-center gap-12 mt-6 md:mt-0">
                    <div className="flex flex-col items-end">
                       <span className="text-[10px] font-bold tracking-[0.2em] text-on-surface-variant/30 uppercase mb-1">Status</span>
                    ...
                    <div className="h-12 w-12 rounded-full border border-outline-variant/20 flex items-center justify-center group-hover:bg-primary group-hover:text-white group-hover:border-primary transition-all duration-300 group/btn">
