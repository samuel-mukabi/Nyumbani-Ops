    ...
    <div className="max-w-6xl mx-auto space-y-12 pb-24 animate-in fade-in duration-700">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 border-y border-outline-variant/10 py-16">
        <div className="space-y-6 group cursor-default">
          ...
          <p className="text-xs leading-relaxed text-on-surface-variant max-w-50">Guests currently confirmed or checked in.</p>
        </div>
        ...
        <div className="space-y-6 group cursor-default">
          ...
          <p className="text-xs leading-relaxed text-on-surface-variant max-w-50">Sent prompts awaiting guest action.</p>
        </div>
        ...
        <div className="space-y-6 group cursor-default">
          ...
          <p className="text-xs leading-relaxed text-on-surface-variant max-w-50">Aggregate value of all processed reservations.</p>
        </div>
      </section>
      ...
      <section className="space-y-12">
        <div className="flex items-end justify-between pb-4 border-b border-outline-variant/10">
          ...
          <span className="text-[10px] font-bold tracking-widest text-on-surface-variant uppercase">{allBookings.length} Total Bookings</span>
        </div>
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-16 lg:gap-24">
                  ...
                  <div className="flex flex-col min-w-45">
                    <span className="text-[10px] font-bold tracking-[0.2em] text-primary uppercase mb-2">Guest</span>
                    ...
                    <span className="text-[10px] font-medium text-on-surface-variant tracking-wider mt-1">{booking.guestPhone}</span>
                  </div>

                  {/* Stay Dates */}
                  <div className="flex flex-col">
                    <span className="text-[10px] font-bold tracking-[0.2em] text-on-surface-variant uppercase mb-2">Stay Duration</span>
                    ...
                    <span className="text-[10px] text-on-surface-variant font-medium uppercase tracking-widest mt-1">
                  ...
                  <div className="hidden lg:flex flex-col">
                    <span className="text-[10px] font-bold tracking-[0.2em] text-on-surface-variant uppercase mb-2">Property</span>
                    <p className="text-sm font-medium text-on-surface max-w-37.5 truncate">{booking.property?.name}</p>
                    <span className="text-[10px] text-on-surface-variant font-light italic mt-0.5">
                ...
                <div className="flex items-center gap-12 mt-8 md:mt-0">
                  ...
                  <div className="flex flex-col items-end">
                    <span className="text-[10px] font-bold tracking-[0.2em] text-on-surface-variant uppercase mb-2">Revenue</span>
                  ...
                  <div className="flex flex-col items-end min-w-25">
                    <span className="text-[10px] font-bold tracking-[0.2em] text-on-surface-variant uppercase mb-2">Status</span>
