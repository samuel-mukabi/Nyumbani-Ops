...
export async function middleware(request: NextRequest) {
  ...
  const protectedPaths = ['/dashboard', '/properties', '/staff', '/compliance', '/onboarding']
  ...
  // but middleware should be as fast as possible.
  // For now, we'll let the application logic handle the detailed org check to avoid double DB hits in middleware.
